...
export function toMinor(amountMajor: number | string, minorUnit: number): bigint {
...
export function toMajor(amountMinor: bigint, minorUnit: number): string {
...
export function formatMoney(money: Money, minorUnit: number, locale = 'en-US'): string {
